...
contract Staking is ReentrancyGuard{
    ...
    function earned(address account)public view returns(uint){
        return((stakedBalance[account].mul(rewardPerToken().sub(userRewardPerTokenPaid[account]))).add(rewards[account]));
    }
...
//Stake time - 1701074743
//withdrawal time -  1701074763
//total reward - 20*10=200

//Stake Token - 0x48d40bd72b15f6b29147fddedd33496afe92ba0e
//RWD - 0x9ddd83182d57066f94c8513619c1b3725f647c75
//Stacking Contract - 0xB1903a09228f422D024A7cb4Ec9CcDaf65D43377